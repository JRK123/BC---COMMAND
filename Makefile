bc:	main.o substraction.o addition.o getnext.o multiplication.o Division.o stack.o cstack.o infix.o takeinput.o usefulfunc.o
	gcc main.o substraction.o multiplication.o addition.o Division.o getnext.o stack.o cstack.o infix.o takeinput.o usefulfunc.o -o project 
...
Division.o:	Division.c husefulfunc.h
	gcc -c Division.c
